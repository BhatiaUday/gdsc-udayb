        ...
        <div className=" w-full h-full relative">
          <div className="  h-fit p-2 pt-0 pl-1">
            <div className="text-2xl font-semibold font-sans text-[#777777]">
              In what context is redux appropriate against reacts (native) state management?
            </div>
          </div>
          ...
          <div className="h-fit w-[70%] text-base text-[#777777] p-2">
            Never used redux before and have always used useContext as projects usually dont have a long lifespan. I know redux is a global state management system but .........
          </div>
